...
- [x] **tests/test_chunk_creator.py** (CRITICAL)
  - Test cases needed:
...
- [x] **tests/test_embedding.py** (CRITICAL)
  - Test cases needed:
...
- [x] **tests/test_json_loader.py** (HIGH)
  - Test cases needed:
...
- [x] **tests/test_storage.py** (CRITICAL)
  - Test cases needed:
...
- [x] **tests/test_validation.py** (HIGH)
  - Test cases needed:
...
- [x] **tests/test_config_loader.py** (HIGH)
  - Test cases needed:
...
- [x] **tests/test_full_pipeline.py** (MEDIUM - Integration tests)
  - Test cases needed:
...
- [x] **Add test dependencies to `setup.py`**
  ```python
  extras_require={
      "dev": [
          "pytest>=7.0",
